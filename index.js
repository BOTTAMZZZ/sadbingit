...
const BotName = 'TamzzzBOTZ'; // GANTI PAKE NAMA BOT LU
...
const ow = 'TAMZZZ GANS'; // GANTI PAKE NAMA MU
const nomorowner = '085609585220'; // GANTI PAKE NOMOR MU ( JANGAN NOMOR BOT )
const ovo = '0856-0958-5220'; // GANTI PAKE NOMOR OVO LU
const pulsa = '0856-0958-5220'; // GANTI PAKE NOMOR PULSA LU
const dana = '0856-0958-5220'; // GANTI PAKE NOMOR DANA LU
const gopay = '0856-0958-5220'; // GANTI PAKE NOMOR GOPAY LU
const instagram = 'http://www.instagram.com/jbtamzz_13'; // GANTI IG LU
const aktif = '08:00 - 22:00'; // TERSERAH LU DAH INI
const vcard = 'BEGIN:VCARD\n'
  + 'VERSION:3.0\n' // MAU NGAPAIN TOD
  + 'FN:TAMZZZ GANS\n' // GANTI PAKE NAMA MU
  + 'ORG:Tamzzz BOTZ;\n' // INI BIARIN GPP, GANTI PAKE NAMA BOT BOLEH
  + 'TEL;type=CELL;type=VOICE;waid=6285609585220:+62 856-0958-5220\n' // GANTI PAKE NOMOR LU ( SAMAIN KEK GITU YA )
...
conn.on('qr', qr => {
  ...
  console.log(`[ ${moment().format("HH:mm:ss")} ] SUBSCRIBE YT DWYTAMZZ FF!`);
});
...
setInterval(function () {
  for (i = 0; i < 3; i++) {
    console.log(`[ ${moment().format("HH:mm:ss")} ] => Hallo I'm Tamzzz :)`)
  }
}, 15000)
...
2. *!nulis*
➸ Untuk membuat tulisan | contoh : !nulis Tamzzz baik hati dan sopan
3. *!stalkig*
➸ Untul stalking ig menggunakan username | contoh : !stalkig jbtamzz_jb
4. *!ssweb*
➸ Mengambil gambar web | contoh : !ssweb http://xnxx.com
5. *!quotes*
➸ Random quotes
6. *!bikinquote*
➸ Untuk membuat quotes gambar | contoh : !bikinquote percuma cantik kalo hasil open bo & Kata Tamzzz
7. *!ytmp3*
...
13.️ *!artinama*
➸ primbon nama kalian | contoh : !artinama Tamzzz
14. *!artijodoh*
➸ primbon jodoh | contoh : !artijodoh Tamzzz & Nadia
15. *!artimimpi*
